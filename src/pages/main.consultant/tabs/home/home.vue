<template>
  <div class="home-view">
    ...
    <f7-list>
      <f7-list-item :title="$t('app.consultanttype')" link="/consultant/type/?isowner=false">
        <i class="f7-icons size-25" slot="media">book_fill</i>
      </f7-list-item>
    </f7-list>
...
export default {
  computed: {
    ...mapState({
      ...
      consultants: state => state.applicationconsultants,
  ...
  methods: {
    ...
    getLink(id) {
      return `/consultant/?mid=${id}&isowner=false`
    }
  }
}
</script>
