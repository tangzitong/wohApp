<template>
  <f7-page>
    ...
    <f7-toolbar tabbar :labels="!isAndroid">
      ...
      <f7-link :icon="!isAndroid ? 'iconfont icon-ios7chatbubble' : ''" :text="$t('app.contacts')" tab-link="#contacts"></f7-link>
      <f7-link :icon="!isAndroid ? 'iconfont icon-ios7cameraoutline' : ''" :text="$t('app.news')" tab-link="#news"></f7-link>
      <f7-link :icon="!isAndroid ? 'iconfont icon-ios7more' : ''" :text="$t('app.data')" tab-link="#data"></f7-link>
      <f7-link :icon="!isAndroid ? 'iconfont icon-ios7person' : ''" :text="$t('app.work')" tab-link="#work"></f7-link>
