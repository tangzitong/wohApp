        ...
        <template v-if="consultantapplications">
          <div class="application flex-row" v-for="application in consultantapplications" :key="application.id">
            ...
            <div class="detail flex-rest-width">
              ...
              <f7-link v-if="application.avatar !== userid && application.approvalStatus === true" class="tool tool-border flex-rest-width" @click="disagreeApplication(consultant.id, application.id)">
                <span class="iconfont icon-thumbup"></span>
                <span class="text" v-text="$t('consultant.disagreeapplication')"></span>
              </f7-link>
              <f7-link v-if="application.avatar !== userid && application.approvalStatus !== true" class="tool tool-border flex-rest-width" @click="agreeApplication(consultant.id, application.id)">
