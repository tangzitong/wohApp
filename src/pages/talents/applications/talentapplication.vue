        ...
        <template v-if="talentapplications">
          <div class="application flex-row" v-for="application in talentapplications" :key="application.id">
            ...
            <div class="detail flex-rest-width">
              ...
              <f7-link v-if="application.avatar !== userid && application.approvalStatus === true" class="tool tool-border flex-rest-width" @click="disagreeApplication(talent.id, application.id)">
                <span class="iconfont icon-thumbup"></span>
                <span class="text" v-text="$t('talent.disagreeapplication')"></span>
              </f7-link>
              <f7-link v-if="application.avatar !== userid && application.approvalStatus !== true" class="tool tool-border flex-rest-width" @click="agreeApplication(talent.id, application.id)">
